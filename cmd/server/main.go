...
import (
	...
	_ "github.com/djan/aflow/docs" // swagger docs
...
func main() {
	...
	// Trigger scheduler — activates cron and webhook triggers on publish.
	...
	// Auth middleware — skip when AFLOW_AUTH_DISABLED=true.
	...
	tools.Register(mcp, wfService, execService)
	...
	e := echo.New()
	e.HideBanner = true
	routes.Register(e, wh, eh, ch, th, mh, wbh, authMW)
